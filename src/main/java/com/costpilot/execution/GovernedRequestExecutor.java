package com.costpilot.execution;
...
public class GovernedRequestExecutor {
	...
	// public rather than package-private only because ChatCompletionsContractTest calls it
	// to exercise the real OpenAI response shaping; this class moved out of `api` in #100,
	// so same-package access from that test no longer applies.
	public ChatCompletionResponse render(CanonicalChatRequest request, CanonicalChatResponse upstream) {
